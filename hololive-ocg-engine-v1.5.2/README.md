...
This project is a dependency-free TypeScript implementation of the Hololive Official Card Game rules needed to play the supplied hSD01 Tokino Sora/AZKi starter deck. Version 1.5.2 makes directly selected battlefield cards open their Action menu immediately and dynamically fits long Art names and dialog headings inside the interface.

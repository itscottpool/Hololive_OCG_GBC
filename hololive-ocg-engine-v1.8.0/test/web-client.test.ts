...
test("browser client guides setup, hides CPU secrets, and completes a match", async t => {
  ...
  assert.match(html, /BUILD v1\.8\.0/);
  ...
  assert.match(script, /openBattleCardActions\(owner, holomem\.stageId\)/);
  ...
  assert.match(styles, /console-title-screen \{[\s\S]{0,180}Courier New/);
  ...
  assert.match(styles, /console-title-logo h1[\s\S]{0,220}font-size: 22px/);

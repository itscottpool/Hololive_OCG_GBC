...
export interface PendingDecision {
  id: string;
  playerId: PlayerId;
  kind: "SUB_PC" | "NORMAL_PC" | "AMAZING_PC" | "LIFE_CHEER" | "CENTER_PROMOTION" | "TOP_CHEER" | "ARCHIVE_CHEERS" | "CARD_EFFECT";
  step:
    | "SELECT_LIMITED"
    | "ORDER_BOTTOM"
    | "SELECT_DEBUT"
    ...
    | "SELECT_REATTACH_CHEER"
    | "SELECT_REATTACH_TARGET"
    | "SELECT_OPPONENT_BACK"
    | "SELECT_HOLO_POWER_CARD"
    | "SELECT_HAND_FOR_HOLO_POWER"
    | "SELECT_OPTIONAL_ARCHIVE_CHEER"
    | "SELECT_ARCHIVE_CHEER"
    | "SELECT_ARCHIVE_CHEER_DESTINATION"
    | "SELECT_FIRST_GRAVITY_CARDS"
    | "ORDER_FIRST_GRAVITY_BOTTOM"
    | "CHOOSE_OPTIONAL_ROLL"
    | "CHOOSE_DIE_METHOD"
    | "DECLARE_DIE_FACE"
    | "CHOOSE_EXPANDING_MAP_RETURN";
  eligibleUids: string[];

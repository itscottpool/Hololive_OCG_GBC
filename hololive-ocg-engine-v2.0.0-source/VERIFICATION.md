...
Verified on September 5, 2026 with Node.js 24.19.0.
...
- Cinematic Art windows retain attacker and target portraits, with the primary-color impact positioned over the target portrait rather than the live battlefield
- Arcade-style opacity/brightness flicker on the cinematic target portrait at the moment of impact
- Oshi die-replacement confirmation panel with card art, Holo Power cost, usage limit, and full printed skill text
- Explicit Replacement playback naming the source and destination Holomem while animating the selected Cheer between them with draw-style one-card motion
...
- Primary-color Art effects for White, Green, Red, Blue, Purple, Yellow, and Neutral Holomem, paired with the supplied universal attack-impact WAV
- Strengthened synthesized retro sound effects for shuffles, draws, card actions, Cheer transfers, and die rolls, plus temporary BGM ducking under attacks
- Supplied hSD01 Tokino Sora/AZKi deck-box artwork in deck selection

...
- Console-style title and menu rendered directly over the title artwork, using the supplied transparent official Hololive OCG logo, a decorative `Endless Nights` subtitle, an upper-right build number, and no development-resolution or vertical-slice labels
...
- Separate persistent BGM and SFX volume levels plus the existing persistent color palettes
...
- Interactive Normal PC deck search and explicit Debut selection

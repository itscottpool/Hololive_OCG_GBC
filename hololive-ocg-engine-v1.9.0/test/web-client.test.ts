...
test("browser client guides setup, hides CPU secrets, and completes a match", async t => {
  ...
  assert.match(html, /BUILD v1\.9\.0/);
  assert.match(html, /styles\.css\?v=1\.9\.0/);
  ...
  assert.match(script, /function battlefieldPoint\(stageId\)/);
  assert.match(script, /battlefield-attack-visual/);
  ...
  assert.match(styles, /battlefield-playback-stage/);
  assert.match(styles, /attack-projectile/);
